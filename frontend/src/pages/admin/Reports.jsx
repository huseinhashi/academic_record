...
export const AdminReports = () => {
  ...
  const exportToPDF = () => {
    ...
    doc.text('Comprehensive System Data Report', pageWidth / 2, 28, { align: 'center' });
    ...
    doc.text(`Generated: ${format(new Date(), 'MMM dd, yyyy')}`, rightColumnX, 72);
    doc.text(`Total Records: ${reportData.length}`, rightColumnX, 80);
    ...
    if (finalY < pageHeight - 50) {
      ...
      doc.text('This report was generated automatically and contains system data information.', 20, finalY + 32);
